...
<section className='flex justify-center items-center w-full bg-[#3896D60F]'>
  <div className="wrapper w-full gap-10 flex flex-col justify-center items-center my-6 mx-6 md:mx-12 lg:mx-20 lg:flex-row">
    <div className="left w-full md:w-[462px] h-[60vh] md:h-[315px] lg:h-full flex justify-center lg:justify-start">
      <div className='px-6 text-center lg:text-left'>
        <h1 className='text-[#3896D6] font-extrabold text-[32px] md:text-[36px] lg:text-[41px]'>GET IN TOUCH</h1>
    ...
    <div className="right bg-white mx-6 py-6 h-auto md:h-[454px] px-6 md:px-10 rounded-3xl w-full md:w-[573px] flex items-center">
