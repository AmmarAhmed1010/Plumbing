      ...
      <section className='flex justify-center items-center w-full bg-[#3896D60F]'>
        <div className="wrapper w-full flex flex-col justify-center items-center my-6 mx-6 md:mx-12 lg:mx-20 lg:flex-row">
          <motion.div
            ...
            whileInView="visible"
            variants={slideLeft}
            className='px-6 text-start lg:text-left w-full md:w-[462px] h-[60vh] md:h-[315px] lg:h-full'
          >
          ...
          <motion.div
            ...
            whileInView="visible"
            variants={slideLeft}
            className="mx-6 py-6 h-auto md:h-[454px] px-6 md:px-10 rounded-3xl w-full md:w-[573px] flex items-center"
          >
