...
const index = () => {
  return (
    ...
    <section className='bg-white gap-10  justify-center items-center h-screen w-full'>
   ...
   <div className=' w-1/2 bg-yellow-200 h-full p-20'>
     <h1 className='text-[#3896D6] text-[41.06px] font-bold'>Southern Gold Coast Plumbing Services</h1>
     <h3 className='text-[#266189] text-[23px]'>Servicing Palm Beach, Currumbin,
     ...
     <h3 className='text-[23px] text-[#266189]'>Prompt Service, Every Time</h3>
   ...
   <button className='bg-blue-900 rounded-3xl text-white'>
    <h3>Learn More</h3>
   </button>
   </div>
</section>
