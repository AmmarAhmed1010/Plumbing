  ...
  return (
    <>
      ...
      <section className='mb-8 flex flex-col md:flex-row items-center justify-center w-full'>
        <div className="flex flex-col mt-20 mb-8 px-6 md:px-16 w-full md:w-[35%] md:mb-0">
          ...
          <p className='text-[16px] text-black mb-4'>When it comes to general maintenance, it's important to catch issues before they become major problems. Our plumbers can assess your plumbing systems and identify any potential issues, ensuring that your plumbing is in top condition and ready to handle whatever comes its way.</p>
          <p className='text-[16px] text-black mb-4'>Leak detection is another important service that we offer. Whether it's a visible leak or one that is hidden from view, our plumber in Burleigh Heads have the tools and expertise to locate the source of the problem and get it fixed.</p>
        ...
        <div className='w-full md:w-1/2 px-8 md:mt-20 h-96 flex justify-center items-center'>
          <Image
